...
Although we don't suggest it, learn how to install QueueMetrics manually on a non-RPM Linux distro or Windows and any other system where you can run Tomcat.
